...
import { CheckCircle2, PhoneCall, ArrowRight, Network, Wifi, Server, Shield } from 'lucide-react';
            ...
            <div className="flex flex-col min-h-screen bg-background">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <a href="tel:+966556704985" className="inline-flex items-center justify-center gap-2 bg-accent hover:bg-emerald-500 text-white px-8 py-4 rounded-xl font-semibold transition-all shadow-lg transform hover:-translate-y-1"><PhoneCall className="w-5 h-5" /> Get a Consultation</a>
                        ...
                        <div className="space-y-6 lg:ml-10">
                            <div className="w-full aspect-square bg-gray-50 rounded-[2.5rem] border border-borderGrey overflow-hidden shadow-sm relative group">
                                <img src="/networking_solutions.webp" alt="office network installation and IT solutions in Riyadh" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000" />
                            </div>
                            <div className="bg-primary rounded-[2rem] p-8 text-white relative overflow-hidden shadow-sm">
                                ...
                                <ul className="space-y-2">{["LAN & WAN setup", "Wi-Fi network design", "Router & switch configuration", "Server setup & management", "Software troubleshooting", "Ongoing IT support contracts"].map((item, i) => (<li key={i} className="flex items-center gap-3 text-gray-200 text-sm"><CheckCircle2 className="w-4 h-4 text-accent shrink-0" /> {item}</li>))}</ul>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-16 bg-background">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl space-y-16">
                        <div>
                            <h2 className="text-3xl font-heading font-extrabold text-textDark mb-6">Office Network Installation in Riyadh</h2>
                            <p className="text-lg text-gray-600 font-sans leading-relaxed mb-4">
                                Establishing a robust and secure office network is critical for any modern business. We specialize in comprehensive office network setup in Riyadh, providing structured cabling systems that form the vital backbone of your IT infrastructure. Our technical teams meticulously plan and execute LAN (Local Area Network) installations to ensure seamless connectivity and high-speed data transfer across all your workstations, servers, and connected office devices.
                            </p>
                            <p className="text-lg text-gray-600 font-sans leading-relaxed">
                                Our process involves the strategic deployment and complete configuration of top-tier routers and enterprise-grade network switches. Whether you are moving into a newly constructed commercial space or upgrading an outdated cabling infrastructure, our professional network installation services guarantee your office runs smoothly without unexpected downtime or connectivity bottlenecks.
                            </p>
                        </div>

                        <div className="pt-8 border-t border-borderGrey">
                            <h2 className="text-3xl font-heading font-extrabold text-textDark mb-6">Business Network Infrastructure Solutions</h2>
                            <p className="text-lg text-gray-600 font-sans leading-relaxed mb-4">
                                Beyond basic connectivity, Perfect Energy Solution delivers advanced business network solutions in Riyadh designed for complex corporate, commercial, and enterprise environments. We construct scalable network architectures capable of handling heavy daily operational loads, integrating local servers, cloud-based applications, and vast internal databases seamlessly.
                            </p>
                            <p className="text-lg text-gray-600 font-sans leading-relaxed">
                                We focus heavily on network security and streamlined traffic management. By implementing smart routing, VLAN configurations, and stringent access controls, we protect your organization's sensitive data against external threats. Our tailored enterprise setups are designed with redundancy in mind, meaning your business network remains resilient and fully operational even during peak demand or service interruptions.
                            </p>
                        </div>

                        <div className="pt-8 border-t border-borderGrey">
                            <h2 className="text-3xl font-heading font-extrabold text-textDark mb-6">Wi-Fi Network Setup for Offices</h2>
                            <p className="text-lg text-gray-600 font-sans leading-relaxed mb-4">
                                Wireless connectivity is the lifeblood of today's agile workplace. We provide professional Wi-Fi installation in Riyadh, eliminating dead zones and providing edge-to-edge coverage throughout your facility. Our process begins with an in-depth wireless site survey to determine the optimal placement for access points, ensuring maximum signal penetration through walls and across large open-plan floors.
                            </p>
                            <p className="text-lg text-gray-600 font-sans leading-relaxed">
                                We optimize Wi-Fi speeds, configure secure guest networks separated from your core business data, and implement advanced roaming protocols so your employees experience uninterrupted connectivity as they move through the office. From small boutique agencies to large multi-story corporate headquarters, our WiFi network setup for business office scenarios ensures absolute reliability.
                            </p>
                        </div>

                        <div className="pt-8 border-t border-borderGrey">
                            <h2 className="text-3xl font-heading font-extrabold text-textDark mb-6">Reliable IT Networking Support in Riyadh</h2>
                            <p className="text-lg text-gray-600 font-sans leading-relaxed mb-4">
                                Setting up a network is only the first step. To maintain optimal performance over time, continuous monitoring and proactive maintenance are essential. That is why we provide dedicated, ongoing IT network support in Riyadh. Our experienced engineers monitor your system's health, applying necessary firmware updates, troubleshooting connectivity anomalies, and resolving software conflicts before they escalate into critical downtime.
                            </p>
                            <p className="text-lg text-gray-600 font-sans leading-relaxed">
                                Whether you require immediate emergency troubleshooting, routine network maintenance, or expert advice on expanding your digital capabilities, our local IT support team is always ready to assist. Partnering with us means you have a dedicated technical ally ensuring your IT environment remains secure, fast, and effortlessly capable of supporting your daily business tasks.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-16"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl"><h2 className="text-2xl font-heading font-bold text-textDark mb-8 text-center">Explore Related Services</h2><div className="grid grid-cols-1 sm:grid-cols-3 gap-4">{[{ title: "CCTV Installation Riyadh", slug: "cctv-installation", desc: "Professional security camera setups." }, { title: "Electrical Services", slug: "electrical-services", desc: "Commercial office wiring & lighting." }, { title: "Laptop & Mobile Sales", slug: "laptop-mobile", desc: "Corporate device supply & repair." }].map((link, idx) => (<Link key={idx} to={`/services/${link.slug}`} className="flex items-center justify-between p-6 bg-background rounded-2xl border border-borderGrey hover:border-accent/30 transition-colors group"><div><h3 className="font-heading font-bold text-textDark mb-1">{link.title}</h3><p className="text-sm text-gray-500">{link.desc}</p></div><ArrowRight className="w-5 h-5 text-accent opacity-0 group-hover:opacity-100 transition-opacity" /></Link>))}</div></div></section>
